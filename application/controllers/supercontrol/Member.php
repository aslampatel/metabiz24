...
class Member extends CI_Controller {
		...
		function index(){
			try{
				...
				$crud->set_subject('user register');
                $crud->set_field_upload('image', 'uploads');
                $crud->columns('name', 'image', 'email', 'phone', 'ref_code', 'spon_code');
                $crud->display_as('ref_code', 'Refferenc Code');
                $crud->display_as('spon_code', 'Sponsered Code');
