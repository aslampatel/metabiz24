...
class About extends CI_Controller {
		...
		function index(){		
			try{
				...
				$crud->set_field_upload('image','uploads/about');
				$crud->set_field_upload('about_page_image','uploads/about');
				$crud->set_field_upload('mission_image','uploads/about');
				$crud->set_field_upload('vision_image','uploads/about');
